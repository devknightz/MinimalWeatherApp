...
abstract class ViewModelModule {
    ...
    abstract ViewModel bindLandingViewModel(LandingViewModel landingViewModel);


    @Binds
    abstract ViewModelProvider.Factory bindViewModelFactory(MinimalViewModelFactory factory);
}
